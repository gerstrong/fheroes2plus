...
const char* Heroes::GetName(int id)
{
    const char* names[] = {
	// knight
	_("Lord Kilburn"), _("Sir Gallanth"), _("Ector"), _("Gwenneth"), _("Tyro"), _("Ambrose"), _("Ruby"), _("Godzilla"), _("Dimitry"),
	// barbarian
	...
	// necromant
	_("Zom"), _("Darlana"), _("Zam"), _("Ranloo"), _("Charity"), _("T-800"), _("Roxana"), _("Sandro"), _("Celia"),
	// campains
