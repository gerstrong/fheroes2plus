...
// T-800 Mod
std::string Settings::GetCampainDir(void)
{
    return GetWriteableDir("campain");
}
// T-800 Mod конец
...
bool Settings::CampainDays(int f) const { return campain_days & f; }
int Settings::CampainDays(void) const { return campain_days; }

void Settings::SetCampainDays(int days) { campain_days = days; }

//bool Settings::CampainDays(int f) const { return game_type & f; }
//int Settings::CampainDays(void) const { return game_type; }

//void Settings::SetCampainDays(int type) { game_type = type; }
